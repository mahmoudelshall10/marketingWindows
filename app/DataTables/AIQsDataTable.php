...
class AIQsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.aiqs.buttons.actions')
    ...
    {
        return AIQ::query()->with(['question_id','answer_id','instructor_id',])->select("a_i_qs.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'answer_id.answer_ar',
                 'data'=>'answer_id.answer_ar',
                 'title'=>trans('admin.answer_id'),
		    ],
				[
                 'name'=>'instructor_id.name',
                 'data'=>'instructor_id.name',
                 'title'=>trans('admin.instructor_id'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
