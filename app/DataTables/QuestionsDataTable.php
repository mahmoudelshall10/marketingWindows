...
class QuestionsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.questions.buttons.actions')
    ...
    {
        return Question::query()->select("questions.*");
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'question_ar',
                 'data'=>'question_ar',
                 'title'=>trans('admin.question_ar'),
		    ],
				[
                 'name'=>'question_en',
                 'data'=>'question_en',
                 'title'=>trans('admin.question_en'),
		    ],
            [
	                'name' => 'actions',
	                'data' => 'actions',
