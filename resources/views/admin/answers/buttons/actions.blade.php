		...
		<div class="actions">
				<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
								<li>
										<a href="{{ aurl('/answers/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('admin.edit')}}</a>
								</li>
								<li class="divider"> </li>
								<li>
										<a href="{{ aurl('/answers/'.$id)}}"><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
								</li>
								<li>
