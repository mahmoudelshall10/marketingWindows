              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('questions/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.questions')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$questions->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$questions->id}}
</div>
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($questions->admin_id)->name }}
</div>
